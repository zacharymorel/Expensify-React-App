...
// console.log('add', add(2, 20))



console.log('adult?', __WEBPACK_IMPORTED_MODULE_0__person_js__["b" /* isAdult */](20))
console.log('can Drink?', __WEBPACK_IMPORTED_MODULE_0__person_js__["a" /* canDrink */](17))
